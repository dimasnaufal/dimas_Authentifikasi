		...
		<div class="container-fluid">
				<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
						<nav class="navbar navbar-default" role="navigation">
							<div class="container-fluid">
								...
								<button type="button" class="navbar-toggle" data-toggle="collapse" data-target=".navbar-ex1-collapse">
									...
									<a class="navbar-brand" href="#">Dimdim</a>
								</div>
					...
					<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
						...
						<a href="<?php echo site_url('jabatan/create/'.$this->uri->segment(3)) ?>" type="button" class="btn btn-primary">Tambah Data Jabatan</a>
							...
							<table class="table table-hover">
								...
								<?php foreach ($jabatan_list as $key) { ?>
									<tr>
										...
										<td>
										<a href="<?php echo site_url('jabatan/delete/').$key->id ?>" onClick="return confirm('apakah anda yakin?')" type="button" class="btn btn-danger">Delete</a>
										</td>
									</tr>
								<?php } ?>
								</tbody>
